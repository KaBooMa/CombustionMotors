...
class Cylinder_60mm : Part
{
    public Cylinder_60mm() : base("CombustionMotors/assets/combustion_motors", "60mm_cylinder", 648388847008624, "60mm Cylinder", "Motors", 9f, true, true)
    {
        AddAttachmentPoint(
            "Block",
