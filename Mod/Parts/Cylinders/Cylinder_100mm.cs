...
class Cylinder_100mm : Part
{
    public Cylinder_100mm() : base("CombustionMotors/assets/combustion_motors", "100mm_cylinder", 740635004256615, "100mm Cylinder", "Motors", 9f, true, true)
    {
        AddAttachmentPoint(
            "Block",
