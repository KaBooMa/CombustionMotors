...
class Cylinder_160mm : Part
{
    public Cylinder_160mm() : base("CombustionMotors/assets/combustion_motors", "160mm_cylinder", 914164327537726, "160mm Cylinder", "Motors", 9f, true, true)
    {
        AddAttachmentPoint(
            "Block",
