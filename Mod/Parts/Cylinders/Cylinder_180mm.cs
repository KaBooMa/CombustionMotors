...
class Cylinder_180mm : Part
{
    public Cylinder_180mm() : base("CombustionMotors/assets/combustion_motors", "180mm_cylinder", 124218524119811, "180mm Cylinder", "Motors", 9f, true, true)
    {
        AddAttachmentPoint(
            "Block",
