...
class Conrod_180mm : Part
{
    public Conrod_180mm() : base("CombustionMotors/assets/combustion_motors", "180mm_con_rod", 69035605824865, "180mm Conrod", "Motors", 0.3f, true, true)
    {
        AddAttachmentPoint(
            "BottomHole",
