...
class Conrod_340mm : Part
{
    public Conrod_340mm() : base("CombustionMotors/assets/combustion_motors", "340mm_con_rod", 823440702986056, "340mm Conrod", "Motors", 0.3f, true, true)
    {
        AddAttachmentPoint(
            "BottomHole",
