...
class Conrod_300mm : Part
{
    public Conrod_300mm() : base("CombustionMotors/assets/combustion_motors", "300mm_con_rod", 654337949736988, "300mm Conrod", "Motors", 0.3f, true, true)
    {
        AddAttachmentPoint(
            "BottomHole",
