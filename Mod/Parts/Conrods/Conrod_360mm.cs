...
class Conrod_360mm : Part
{
    public Conrod_360mm() : base("CombustionMotors/assets/combustion_motors", "360mm_con_rod", 72184425190864, "360mm Conrod", "Motors", 0.3f, true, true)
    {
        AddAttachmentPoint(
            "BottomHole",
