...
class Crankshaft_70mm : Part
{
    public Crankshaft_70mm() : base("CombustionMotors/assets/combustion_motors", "70mm_crank", 560862898520754, "70mm Crankshaft", "Motors", 1.5f, true, true)
    {
        AddAttachmentPoint(
            "RotaryBearingCenter",
