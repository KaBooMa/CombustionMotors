...
class Crankshaft_220mm : Part
{
    public Crankshaft_220mm() : base("CombustionMotors/assets/combustion_motors", "220mm_crank", 400963484569324, "220mm Crankshaft", "Motors", 1.5f, true, true)
    {
        AddAttachmentPoint(
            "RotaryBearingCenter",
