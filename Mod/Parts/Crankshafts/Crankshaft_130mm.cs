...
class Crankshaft_130mm : Part
{
    public Crankshaft_130mm() : base("CombustionMotors/assets/combustion_motors", "130mm_crank", 343591556594011, "130mm Crankshaft", "Motors", 1.5f, true, true)
    {
        AddAttachmentPoint(
            "RotaryBearingCenter",
