...
class Crankshaft_50mm : Part
{
    public Crankshaft_50mm() : base("CombustionMotors/assets/combustion_motors", "50mm_crank", 440987268931632, "50mm Crankshaft", "Motors", 1.5f, true, true)
    {
        AddAttachmentPoint(
            "RotaryBearingCenter",
