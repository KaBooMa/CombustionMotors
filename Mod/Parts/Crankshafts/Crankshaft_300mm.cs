...
class Crankshaft_300mm : Part
{
    public Crankshaft_300mm() : base("CombustionMotors/assets/combustion_motors", "300mm_crank", 280304310448168, "300mm Crankshaft", "Motors", 1.5f, true, true)
    {
        AddAttachmentPoint(
            "RotaryBearingCenter",
