...
class Crankshaft_90mm : Part
{
    public Crankshaft_90mm() : base("CombustionMotors/assets/combustion_motors", "90mm_crank", 166807392227492, "90mm Crankshaft", "Motors", 1.5f, true, true)
    {
        AddAttachmentPoint(
            "RotaryBearingCenter",
