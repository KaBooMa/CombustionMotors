...
class Crankshaft_110mm : Part
{
    public Crankshaft_110mm() : base("CombustionMotors/assets/combustion_motors", "110mm_crank", 357506108958274, "110mm Crankshaft", "Motors", 1.5f, true, true)
    {
        AddAttachmentPoint(
            "RotaryBearingCenter",
