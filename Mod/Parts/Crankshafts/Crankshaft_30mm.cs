...
class Crankshaft_30mm : Part
{
    public Crankshaft_30mm() : base("CombustionMotors/assets/combustion_motors", "30mm_crank", 143271181772935, "30mm Crankshaft", "Motors", 1.5f, true, true)
    {
        AddAttachmentPoint(
            "RotaryBearingCenter",
