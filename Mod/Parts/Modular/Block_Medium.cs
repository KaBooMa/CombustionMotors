...
class Block_Medium : Part
{
    public Block_Medium() : base("CombustionMotors/assets/combustion_motors", "medium_block", 880223382281436, "Medium Engine Block", "Props", 12.5f, true)
    {
        AddAttachmentPoint(
            "FixedBottom",
