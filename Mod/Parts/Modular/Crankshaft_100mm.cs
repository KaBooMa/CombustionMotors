...
{
    public Crankshaft_100mm() : base("CombustionMotors/assets/combustion_motors", "100mm_crankshaft", 20559010901721, "100mm Crankshaft", "Props", 3f, true)
    {
        AddAttachmentPoint(
            "RotaryBearingCenter",
        ...
        AddBehaviour<Crankshaft_100mmBehaviour>();
    }
}